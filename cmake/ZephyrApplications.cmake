...
foreach(TEST_NAME ${ZEPHYR_APPS})
    ...
    set(RISCV_GCC_PREFIX "${RISCV_GCC_TOOLCHAIN_PATH}/bin/riscv32-unknown-elf-")
    set(BEEHIVE_LLVM_PREFIX "${RISCV_LLVM_TOOLCHAIN_PATH}/bin/")
    add_custom_command(
        OUTPUT ${OUTPUT_PATH}/zephyr/zephyr.elf
        COMMAND ${CMAKE_SOURCE_DIR}/cmake/helpers/zephyr_build.sh
            ${TEST_PATH} ${OUTPUT_PATH} ${RISCV_GCC_PREFIX} ${BEEHIVE_LLVM_PREFIX}
