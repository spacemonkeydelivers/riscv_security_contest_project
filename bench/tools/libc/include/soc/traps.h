...
#define D_SOC_INTERRUPTS \
    ...
    D_ENUM_ENTRY(RISCV_INT_STUB1, "FUTURE_STUB1", 12) \
    D_ENUM_ENTRY(RISCV_INT_STUB2, "FUTURE_STUB2", 13) \
    D_ENUM_ENTRY(RISCV_INT_STUB3, "FUTURE_STUB3", 14) \
    D_ENUM_ENTRY(RISCV_INT_STUB4, "FUTURE_STUB4", 15) \
    D_ENUM_ENTRY(RISCV_INT_SM_PANIC, "Secure Monitor Panic", 16) \
    D_ENUM_ENTRY(RISCV_INT_TOTAL, "TOTAL", 17) \
