...
#ifndef RISCV_OVPWORLD_ORG_PROCESSOR_RISCV_RV32IMAC__1_0
#define RISCV_OVPWORLD_ORG_PROCESSOR_RISCV_RV32IMAC__1_0

#include "ovpworld.org/modelSupport/tlmProcessor/1.0/tlm2.0/tlmProcessor.hpp"
using namespace sc_core;

class riscv_RV32IMAC : public icmCpu
{
  private:
    const char *getModel() {
  ...
  public:
    ...
    , INSTRUCTION (this, "INSTRUCTION", 34)
    , DATA (this, "DATA", 34)
    , reset("reset", this)
    , nmi("nmi", this)
